  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-12">
      ...
      <p className="mt-3 max-w-2xl leading-7 text-[#6c756d]">
        MVP 先保留免費與付費版差異展示，暫不串接金流。免費會員每日 10 則，訪客每日 5 則。
      </p>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        <section className="rounded-lg border border-[#e6dfd3] bg-[#fffdf7] p-6">
          ...
          <p className="mt-3 leading-7 text-[#6c756d]">適合初次體驗陪伴式整理與基本情緒紀錄，每日保留輕量使用額度。</p>
          <Link
            href="/experience"
        ...
        <section className="rounded-lg border border-[#8da892] bg-[#fffdf7] p-6">
          ...
          <p className="mt-3 leading-7 text-[#6c756d]">預留給高頻整理、長期保存與主動提醒的使用者，第一版先不收款。</p>
          <button
            type="button"
            disabled
